...
public class Server {
    ...
    private class NioThread extends Worker {
        ...
        protected void init() throws Exception {
            ...
            //перевод в неблокирующицй режим
        ...
        protected void loop() throws Exception {
            ...
            while (iterator.hasNext()) {
                ...
                // для каждого входящего подключения создается новый канал
                if (key.isAcceptable()) {
                    // получение канала
                ...
                // флаг означает что пришли данные в канал для чтения
                ...
                // isWritable проверяет что в канал можно писать данные (канал готов к отправке данных)
