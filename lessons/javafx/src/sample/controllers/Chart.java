...
public class Chart implements Initializable {
    ...
    @FXML
    private BarChart<String, Integer> taskCharts;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        series1.getData().add(new XYChart.Data<>("Не завершенные", 12));
        ...
        series2.getData().add(new XYChart.Data<>("Не завершенные", 35));
